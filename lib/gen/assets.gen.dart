...
class $AssetsImagesGen {
  ...
  /// File path: assets/images/threat.png
  AssetGenImage get threat => const AssetGenImage('assets/images/threat.png');

  /// File path: assets/images/threaticon.png
  AssetGenImage get threaticon =>
      const AssetGenImage('assets/images/threaticon.png');

  /// File path: assets/images/willpower.png
  AssetGenImage get willpower =>
      const AssetGenImage('assets/images/willpower.png');
